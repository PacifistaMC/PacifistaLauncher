window.onload = async function () {
    ...
    document.getElementById('username').textContent = selectedAccount.name;
    ...
    document.getElementById('total-ram').textContent = `RAM totale: ${config.javaConfig.maxRAM} GB`;
    ...
    function setAllocatedRamValue(value) {
        document.getElementById('allocated-ram-value').textContent = `${value ?? allocatedRam.value} GB`;
    }
